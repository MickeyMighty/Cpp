...
{
  std::cout << "\033[1;32mClapTrap Default Constructor has been called\033[0m" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _hitpoint(10), _energypoint(10), _attackdamage(0)
{
  std::cout << "\033[1;32mClapTrap Constructor has been called\033[0m" << std::endl;
  this->_name = name;
}

ClapTrap::~ClapTrap()
{
  std::cout << "\033[1;32mClapTrap Destructor of \033[0m" << this->_name << "\033[0m has been called\033[0m" << std::endl;
}
...
void  ClapTrap::attack(const std::string& target)
{
  if (this->_hitpoint == 0)
    ...
    if (this->_attackdamage == 0 && this->_energypoint > 0) {
      std::cout << "\033[1;33mClapTrap \033[0m" << this->_name << \
      "\033[1;34m attacks on \033[0m" << target << "\033[1;34m causing \033[0m" << \
      this->_attackdamage \
